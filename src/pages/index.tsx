...
const Home: NextPage = () => {
  return (
    <PageLayout>
      <section id="intro" className="p-10 h-[700px] bg-borderDark flex justify-center items-center">
        <h1 className="text-h1">Intro section</h1>
      </section>
      <section id="about" className="p-10 min-h-[700px]">
